...
class Template:
    ...
    def set_rich_card(
        ...
        FIX (GAP 22): Added media_type parameter — templates.py passes it but
        the old signature didn't accept it, causing a TypeError on every
        rich-card template create/update call.
